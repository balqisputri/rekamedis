...
if (!isset($_SESSION['ssLoginRM'])) {
    ...
    $title = "Add Medicine - Rekam Medis";
    ...
    if ($msg == "added") {
        $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong><i class="bi bi-bag-check-fill align-top"></i> Adding new medicine worked</strong>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Name Medicine" require>
                </div>
            <div class="form-group mb-3">
                <label for="kegunaan" class="form-label">Purpose </label>
                <textarea name="kegunaan" id="kegunaan" cols="" rows="" class="form-control" placeholder="Medicinal Uses" required></textarea>
            </div>
