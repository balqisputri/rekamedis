...
<head>
    <script src="<?= $main_url ?>asset/js/color-modes.js"></script>
    ...
    <link rel="icon" type="image/x-icon" href="<?= $main_url ?>asset/gambar/logo.png">
    ...
    <!-- Custom styles for this template -->
    <link href="<?= $main_url ?>asset/dashboard/dashboard.css" rel="stylesheet">
