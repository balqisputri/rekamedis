...
<body>
    ...
    <table>
        <thead>
            ...
            <tr>
                <th class="table-head" style="width: 90px;">Date</th>
                <th class="table-head" style="width: 200px;">Complaint</th>
                <th class="table-head" style="width: 120px;">Diagnosis</th>
                <th class="table-head" style="width: 200px;">Medicine</th>
                <th class="table-head" style="width: 70px;">Doctor</th>
            </tr>
            <tr>
                <th colspan="5">
                    <hr size="3">
...
$sqlrm = "SELECT * FROM tbl_rekammedis INNER JOIN tbl_user ON tbl_rekammedis.id_dokter = tbl_user.userid WHERE id_pasien = '$id'";
