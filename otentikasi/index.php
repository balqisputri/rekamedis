...
<link href="<?= $main_url?>asset/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <style>
      ...
      #bg-login{
        background-image: url(../asset/gambar/bg-4.png);
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary text-center" id="bg-login">
...
<main class="form-signin w-100 m-auto">
  <form action="proses-login.php" method="post">
    <img class="mb-4" src="<?= $main_url ?>asset/gambar/app-icon.png" alt="" width="auto" height="auto">
    <h1 class="h3 mb-4 fw-normal text-white">Rekam Medis</h1>
    ...
    <button class="btn btn-primary w-100 py-2 mt-3" type="submit" name="login">Sign in</button>
    <p class="mt-5 mb-3 text-white">&copy; DOLDAM Hospital - 2024</p>
  </form>
</main>
